...
def extract_metadata_from_png(png_file, chunk_type):
    """
...
def _extract_keywords(metadata: dict) -> list[str]:
    """
...
def _clean_caption(lines: list) -> str:
    """
...
def generate_caption(subject: str, metadata: dict, include_appearance: bool) -> str:
    """
    ...
    if location:
        ...
        caption: str = caption.replace("#LOCATION#", "")
    if subject:
...
if __name__ == "__main__":
    ...
    main(args.source, args.subject, args.include_appearance)
